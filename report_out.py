...
class ParseData:
    ...
    def get_data(self, vacancies, prof):
        ...
        for vacancy in vacancies:
            ...
            if prof.lower() in vacancy.name.lower():
        ...
        self.salary_lvl_by_year_for_prof = dict(sorted(self.salary_lvl_by_year_for_prof.get_aver_salary().items()))
        self.count_vac_by_year_for_prof = dict(sorted(self.count_vac_by_year_for_prof.count_dict.items()))
        return self.salary_lvl_by_year.get_aver_salary(), self.count_vac_by_year.count_dict, \
               self.salary_lvl_by_year_for_prof, self.count_vac_by_year_for_prof, \
...
class Report:
    ...
    def generate_image(self):
        ...
        self.ax2.bar(x_list2_2, self.count_vac_by_year_for_prof.values(), width_12, label=f'Количество вакансий\n{self.prof}')
    ...
    def generate_pdf(self):
        ...
        for i in range(len(list(self.salary_lvl_by_city.keys()))):
            statistics_by_city_dic.append([list(self.salary_lvl_by_city.keys())[i], list(self.vacancy_rate_by_city.keys())[i]])
        for key, value in self.vacancy_rate_by_city.items():
